<template>
  <footer class="bg-grey-lighter px-2 py-2 flex items-center">
    ...
    <div class="flex-1 mx-2">
      <input v-model="message" class="w-full border rounded px-2 py-2" type="text" placeholder="Message #general"  v-on:keyup.enter="sendMessage" :disabled="isDisabled" />
    </div>
    <div>
      <button v-on:click="sendMessage" :disabled="isDisabled" >
